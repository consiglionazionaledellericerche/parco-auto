...
public interface LibrettoPercorrenzaVeicoloRepository extends JpaRepository<LibrettoPercorrenzaVeicolo, Long> {
    ...
    @Query("SELECT lpv FROM LibrettoPercorrenzaVeicolo lpv where lpv.veicolo.istituto in :istituto AND lpv.veicolo.deleted =:deleted")
    public Page<LibrettoPercorrenzaVeicolo> findByIstitutoStartsWithAndDeteled(@Param("istituto") List<String> istituto, @Param("deleted") Boolean deleted, Pageable pageable);
