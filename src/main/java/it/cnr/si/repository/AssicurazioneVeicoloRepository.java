...
public interface AssicurazioneVeicoloRepository extends JpaRepository<AssicurazioneVeicolo, Long> {
    ...
    @Query("SELECT av FROM AssicurazioneVeicolo av where av.veicolo.istituto in :istituto AND av.veicolo.deleted =:deleted")
    public Page<AssicurazioneVeicolo> findByIstitutoStartsWithAndDeleted(@Param("istituto") List<String> istituto, @Param("deleted") Boolean deleted, Pageable pageable);
